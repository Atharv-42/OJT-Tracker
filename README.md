...
| Action | How |
|---|---|
| Add a task | Fill the form in the sidebar → click **+ Add Task** (or press Enter) |
| Complete a task | Click **✓ Complete** on the task card |
| Delete a task | Click **✕ Delete** on the task card |
| Filter tasks | Click a status tab (All / Pending / In Progress / Completed) |
| Search tasks | Type in the search box |
| Save a note | Click **Save Note** or press **Ctrl + S** |
| Switch note tabs | Click Learnings / Mentor Feedback / Error Log |
